    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='location_name', to='location.location')),
                ('table_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booked_table', to='location.table')),
            ],
            options={
                'ordering': ['date'],
            },
